...
const ToolBar: React.FC<{ onData: DataCallback; highlighted: string }> = ({
  onData,
  highlighted,
}) => {
  ...
  const updateActiveCritique = (
    prev: typeof baseCritique,
    property: keyof typeof baseCritique
  ) => {
    const result = {
      ...prev,
      ...
      <div className="flex gap-5 items-center flex-wrap">
        <div className="relative flex items-center">
          ...
          <button
            type="button"
            onClick={fetchData}
            className="absolute right-0 text-zinc-600 ring-1 ring-zinc-600 font-small rounded-full text-sm p-1 mr-2 text-center inline-flex items-center"
          >
            <svg
        ...
        <button
          ...
          onClick={() =>
            setActiveCritique((prev) =>
              updateActiveCritique(prev, "improveWriting")
            )
          }
        >
          <span
        ...
        <button
          ...
          onClick={() =>
            setActiveCritique((prev) =>
              updateActiveCritique(prev, "makeLonger")
            )
          }
        >
          <span
        ...
        <button
          ...
          onClick={() =>
            setActiveCritique((prev) =>
              updateActiveCritique(prev, "makeShorter")
            )
          }
        >
          <span
        ...
        <button
          ...
          onClick={() =>
            setActiveCritique((prev) =>
              updateActiveCritique(prev, "fixSpellingAndGrammar")
            )
          }
        >
          <span
